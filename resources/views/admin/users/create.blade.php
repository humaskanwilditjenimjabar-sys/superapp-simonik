<div>
    ...
    <div
        ...
        <div style="display:flex;align-items:center;gap:0.875rem;">
            ...
            <div>
                <h2 style="font-size:0.9375rem;font-weight:800;color:white;margin:0;letter-spacing:-0.01em;">Tambah User
                    Baru</h2>
                <p style="font-size:0.6875rem;color:rgba(255,255,255,0.55);margin:0.2rem 0 0;">Isi form berikut untuk
                    menambahkan user baru ke sistem</p>
            </div>
        </div>
        ...
        'nonaktif' => ['label' => 'Nonaktif', 'icon' => 'M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636'],
            ...
            <div style="display:flex;gap:0.75rem;">
                ...
                <button wire:click="simpan"
                    style="flex:2;padding:0.75rem;border-radius:0.75rem;background:#1e3a8a;color:white;font-size:0.875rem;font-weight:700;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:0.5rem;"
