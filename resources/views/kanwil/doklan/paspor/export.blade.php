        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xs mt-0.5" style="color:rgba(255,255,255,0.55);">
                    Kanwil Ditjenim Jabar · {{ today()->translatedFormat('d F Y') }}
                </p>
            </div>
        </div>
        <div class="flex items-center gap-2">
            <a href="{{ route('kanwil.doklan.paspor.export.excel', [
                'filter_kanim' => $filterKanim,
            ...
            <a href="{{ route('kanwil.doklan.paspor.export.pdf', [
                'filter_kanim' => $filterKanim,
                'filter_lokasi' => $filterLokasi,
                'filter_dari' => $filterDari,
                'filter_sampai' => $filterSampai,
    ...
    <div class="bg-white rounded-2xl overflow-hidden" style="border:1px solid #E2E8F0;">
        <div class="px-4 py-3 flex items-center justify-between"
            ...
            <div class="flex items-center gap-2">
                ...
                @if ($filterKanim || $filterLokasi || $filterDari || $filterSampai || $filterJenis)
        ...
        <div class="p-4 grid grid-cols-1 sm:grid-cols-5 gap-3">
            {{-- Kanim --}}
            <div>
                <label class="block text-xs font-medium mb-1.5" style="color:#64748B;">Kantor Imigrasi</label>
                ...
                <thead>
                    <tr style="background:#1E3A8A;">
                        ...
                        <th wire:click="sort('tanggal')"
                            ...
                            <span style="display:flex;align-items:center;gap:0.375rem;">Tanggal
                        ...
                        <th wire:click="sort('kanim_id')"
                            class="px-4 py-3 text-left text-xs font-bold text-white cursor-pointer">
                            <span style="display:flex;align-items:center;gap:0.375rem;">Kanim
                                @if ($sortColumn === 'kanim_id')
                                    <span
                                    style="color:#d4af37;">{{ $sortDirection === 'asc' ? '↑' : '↓' }}</span>@else<span
                                        class="opacity-30">↕</span>
                                @endif
                        ...
                        <th wire:click="sort('jenis_layanan_id')"
                            class="px-4 py-3 text-left text-xs font-bold text-white cursor-pointer">
                            <span style="display:flex;align-items:center;gap:0.375rem;">Jenis Layanan
                        ...
                        <th wire:click="sort('lokasi_layanan_id')"
                            class="px-4 py-3 text-left text-xs font-bold text-white cursor-pointer">
                            <span style="display:flex;align-items:center;gap:0.375rem;">Lokasi
                                @if ($sortColumn === 'lokasi_layanan_id')
                                    <span
                                    style="color:#d4af37;">{{ $sortDirection === 'asc' ? '↑' : '↓' }}</span>@else<span
                                        class="opacity-30">↕</span>
                                @endif
                        ...
                        <th wire:click="sort('jumlah')"
                            ...
                            <span style="display:flex;align-items:center;justify-content:center;gap:0.375rem;">Jumlah
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-4 py-3.5">
                                <p class="text-xs font-medium" style="color:#374151;">
                                    {{ $item->operator?->nama_lengkap ?? '(Kanwil)' }}</p>
                                <p class="text-xs" style="color:#94a3b8;">{{ $item->operator?->nip ?? '' }}</p>
                            </td>
                            <td class="px-4 py-3.5 text-center">
                                @php
                                    $stStyle = match ($item->status) {
